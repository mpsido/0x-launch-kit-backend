...
(async () => {
     ...
     */
    app.get('/v2/asset_pairs', userMiddleware, asyncHandler(Handlers.assetPairsAsync.bind(Handlers)));
    /**
     ...
     */
    app.get('/v2/orders', userMiddleware, asyncHandler(handlers.ordersAsync.bind(handlers)));
    /**
     ...
     */
    app.get('/v2/orderbook', userMiddleware, asyncHandler(handlers.orderbookAsync.bind(handlers)));
    /**
     ...
     */
    app.post('/v2/order_config', userMiddleware, Handlers.orderConfig.bind(Handlers));
    /**
     ...
     */
    app.get('/v2/fee_recipients', userMiddleware, Handlers.feeRecipients.bind(Handlers));
    /**
     * POST Order endpoint submits an order to the Relayer.
     * http://sra-spec.s3-website-us-east-1.amazonaws.com/#operation/postOrder
     */
    app.post('/v2/order', userMiddleware, asyncHandler(handlers.postOrderAsync.bind(handlers)));
    /**
     * GET Order endpoint retrieves the order by order hash.
     * http://sra-spec.s3-website-us-east-1.amazonaws.com/#operation/getOrder
     */
    app.get('/v2/order/:orderHash', userMiddleware, asyncHandler(Handlers.getOrderByHashAsync.bind(Handlers)));
